...
import (
	crv1 "apiextensions-apiserver/pkg/apis/cr/v1"
	versioned "apiextensions-apiserver/pkg/client/clientset/versioned"
	internalinterfaces "apiextensions-apiserver/pkg/client/informers/externalversions/internalinterfaces"
	v1 "apiextensions-apiserver/pkg/client/listers/cr/v1"
	"context"
	time "time"
